    const Pharmacies_W47 = 
      { label: '<strong style="font-size: 14px; color:green;"> W.Ghardaia</strong>', selectAllCheckbox: true, children: [

        { label: '<strong style="font-size: 14px; color:red;"> Commune A1</strong>', selectAllCheckbox: true, children: [
        ...
        { label: '<strong style="font-size: 14px; color:red;"> Commune B2</strong>', selectAllCheckbox: true, children: [
